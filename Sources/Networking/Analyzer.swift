...
@Lockable public class Analyzer: @unchecked Sendable {
  ...
  public var forwardProtocol: (any ForwardProtocolConvertible)
          ...
          try await withSpan("initialize VPN request") { span in
            ...
            do {
              ...
              guard let sourceEndpoint = try serverChildChannel.remoteAddress?.asAddress() else {
                throw AnlzrError.inputStreamEndpointInvalid
              }
