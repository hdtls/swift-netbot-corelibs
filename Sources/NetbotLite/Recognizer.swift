...
extension Recognizer {
  ...
  final class Handler<R: Recognition>: ChannelInboundHandler, RemovableChannelHandler {
    ...
    private let completion: (RecognizedResult) -> EventLoopFuture<Void>

    init(completion: @escaping @Sendable (RecognizedResult) -> EventLoopFuture<Void>) {
    ...
    func channelRead(context: ChannelHandlerContext, data: NIOAny) {
      ...
      case .waitingForData:
        ...
        completion(R.recognize(unwrapInboundIn(data)))
