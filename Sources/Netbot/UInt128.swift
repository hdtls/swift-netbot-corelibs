...
// swift-format-ignore-file
  ...
  @available(iOS, deprecated: 18.0, renamed: "UInt128")
  @available(macOS, deprecated: 15.0, renamed: "UInt128")
  @available(tvOS, deprecated: 18.0, renamed: "UInt128")
  @available(watchOS, deprecated: 11.0, renamed: "UInt128")
  @available(visionOS, deprecated: 2.0, renamed: "UInt128")
  ...
  @available(iOS, deprecated: 18.0, renamed: "Int128")
  @available(macOS, deprecated: 15.0, renamed: "Int128")
  @available(tvOS, deprecated: 18.0, renamed: "Int128")
  @available(watchOS, deprecated: 11.0, renamed: "Int128")
  @available(visionOS, deprecated: 2.0, renamed: "Int128")
  ...
  private func _wideDivide32<F: FixedWidthInteger & UnsignedInteger>(
    ...
    let product = _wideAddReportingOverflow33(
      ...
      (high: p2.high, mid: p2.low, low: .zero)
    ).partialValue
    ...
    while remainder < product {
      quotient = quotient &- 1
      remainder =
        _wideAddReportingOverflow33(
          remainder,
          (high: F.zero, mid: F.Magnitude(rhs.high), low: rhs.low)
        ).partialValue
    }
  ...
  private func _wideDivide42<F: FixedWidthInteger & UnsignedInteger>(
    ...
    if lhs.high.high == F.Magnitude.zero,
  ...
  extension _Int128 {
    internal func dividedBy1e18() -> (quotient: Self, remainder: Self) {
      let m = _Int128(high: 664_613_997_892_457_936, low: 8_336_148_766_501_648_893)
      var q = self.multipliedFullWidth(by: m).high
      q &>>= 55
      // Add 1 to q if self is negative
      q &+= _Int128(bitPattern: _UInt128(bitPattern: self) &>> 127)
      let r = self &- q &* (1_000_000_000_000_000_000 as _Int128)
      return (q, r)
    }
  }
  ...
  extension _Int128 {
    internal func dividedBy1e15() -> (quotient: Self, remainder: Self) {
      let m = _Int128(high: -8_062_150_356_639_896_359, low: 1_125_115_960_621_402_641)
      var q = self.multipliedFullWidth(by: m).high
      q &+= self
      q &>>= 49
      // Add 1 to q if self is negative
      q &+= _Int128(bitPattern: _UInt128(bitPattern: self) &>> 127)
      let r = self &- q &* (1_000_000_000_000_000 as _Int128)
      return (q, r)
    }
  }
  ...
  extension _Int128 {
    internal func dividedBy1e12() -> (quotient: Self, remainder: Self) {
      let m = _Int128(high: 2_535_301_200_456_458_802, low: 18_325_113_820_324_532_597)
      var q = self.multipliedFullWidth(by: m).high
      q &>>= 37
      // Add 1 to q if self is negative
      q &+= _Int128(bitPattern: _UInt128(bitPattern: self) &>> 127)
      let r = self &- q &* (1_000_000_000_000 as _Int128)
      return (q, r)
    }
  }
  ...
  extension _Int128 {
    internal func dividedBy1e9() -> (quotient: Self, remainder: Self) {
      let m = _Int128(high: 4_951_760_157_141_521_099, low: 11_003_425_581_274_142_745)
      var q = self.multipliedFullWidth(by: m).high
      q &>>= 28
      // Add 1 to q if self is negative
      q &+= _Int128(bitPattern: _UInt128(bitPattern: self) &>> 127)
      let r = self &- q &* (1_000_000_000 as _Int128)
      return (q, r)
    }
  }
  ...
  extension _Int128 {
    internal func dividedBy1e6() -> (quotient: Self, remainder: Self) {
      let m = _Int128(high: 604_462_909_807_314_587, low: 6_513_323_971_497_958_161)
      var q = self.multipliedFullWidth(by: m).high
      q &>>= 15
      // Add 1 to q if self is negative
      q &+= _Int128(bitPattern: _UInt128(bitPattern: self) &>> 127)
      let r = self &- q &* (1_000_000 as _Int128)
      return (q, r)
    }
  }
  ...
  extension _Int128 {
    internal func dividedBy1e3() -> (quotient: Self, remainder: Self) {
      let m = _Int128(high: 4_722_366_482_869_645_213, low: 12_838_933_875_301_847_925)
      var q = self.multipliedFullWidth(by: m).high
      q &>>= 8
      // Add 1 to q if self is negative
      q &+= _Int128(bitPattern: _UInt128(bitPattern: self) &>> 127)
