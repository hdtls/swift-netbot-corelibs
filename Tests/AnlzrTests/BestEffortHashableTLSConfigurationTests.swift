...
@Suite struct BestEffortHashableTLSConfigurationTests {
  ...
  func hashableConformance() async throws {
    let cfg1 = TLSConfiguration.makeClientConfiguration()
    let cfg2 = TLSConfiguration.makeClientConfiguration()
  ...
  func differentConfigurations() async throws {
    let cfg1 = TLSConfiguration.makeClientConfiguration()
    var cfg2 = TLSConfiguration.makeClientConfiguration()
  ...
  func hashableInSetAndDict() async throws {
    let cfg = TLSConfiguration.makeClientConfiguration()
