...
@Suite struct SSLContextCacheTests {
  ...
  func differentConfigsGetDifferentContexts() throws {
    let config1 = TLSConfiguration.makeClientConfiguration()
    var config2 = TLSConfiguration.makeClientConfiguration()
  ...
  func eviction() throws {
    ...
    let config0 = TLSConfiguration.makeClientConfiguration()
