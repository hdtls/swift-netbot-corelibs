...
@Suite struct V1_ProcessReportTests {
  ...
  extension V1_ProcessReportTests {
    ...
    @Test func query() async throws {
      ...
      let fetched = try modelContext.fetch(FetchDescriptor<V1.ProcessReport>()).first
